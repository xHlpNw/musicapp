...
INSERT INTO album_tracks (position, album_id, track_id) SELECT 1, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Пески времени' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 2, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Чудовище погубившее мир' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 3, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Чучело' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 4, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'В хрущевских и брежневских домах' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 5, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Мёртвый игрок' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 6, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Лёд выдержит' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 7, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'ЧДПБЛ' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 8, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Могилам II' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 9, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Вечное возвращение' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 10, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Остров' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 11, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Комната' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 12, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Мальчиш плохиш' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 13, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Похоронка' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 14, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Домики у моря' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 15, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Больно' LIMIT 1;
INSERT INTO album_tracks (position, album_id, track_id) SELECT 16, al.id, t.id FROM albums al, tracks t WHERE al.title = 'Чудовище погубившее мир' AND t.title = 'Я убью себя' LIMIT 1;
